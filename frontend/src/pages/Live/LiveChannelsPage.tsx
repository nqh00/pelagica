...
import { Grid2x2, ListTree, Tv } from 'lucide-react';
...
function getProgramTimeRange(startDate?: string | null, endDate?: string | null): string | undefined {
                    ...
                    {!isLoading && data && data.items.length === 0 && (
                        <Empty>
                            <EmptyHeader>
                                ...
                                <EmptyDescription>
                                    {t('live:no_channels_description')}
                                </EmptyDescription>
                            </EmptyHeader>
                        </Empty>
                    )}
